...
6.2. Date or time limit after which service is no longer necessary (2) :
   (day)(month) (year)
...
6.3. Language of document:
   ...
   6.3.2. translation (2)  BG □, ES □, CS □, DE □, ET □, EL □, EN □, FR □, GA □, HR □, IT □, LV □, LT □, HU □, MT □, NL □, PL □, PT □, RO □, SK □, SL □, FI □, SV □, other □ (please specify)
...
7.1. Official language or one of the official languages of the Member State of origin (<sup>4</sup>): BG □, ES □, CS □, DE □, ET □, EL □, EN □, FR □, GA □, HR □, IT □, LV □, LT □, HU □, MT □, NL □, PL □, PT □, RO □, SK □, SL □, FI □, SV□
...
#### 9. **REASONS FOR NOT TRANSMITTING THROUGH THE DECENTRALISED IT SYSTEM (Article 5(4) of Regulation (EU) 2020/1784) (<sup>5</sup>)**
...
1. The request cannot be executed without the following additional information:
   1.1. Addressee’s identity (<sup>9</sup>):
   1.2. Date of birth (9) :
   1.3. Identification number/social security number/organisation number/or equivalent (9) :
   1.4. Other (please specify):

2. The request cannot be executed without the following documents:
   2.1. Documents to be served (9) :
   2.2. Proof of payment (9) :
...
4.6. Identification number/social security number/organisation number/or equivalent (12) :

4.7. Any other information relating to the addressee (12) :
...
1.2. The document was
   1.2.1. served in accordance with the law of the Member State addressed, namely
      1.2.1.1. handed to□
         ...
         1.2.1.1.4. another address (please specify) (<sup>14</sup>)
...
4.1. Address unknown
   4.1.1. Steps to establish the address were undertaken (<sup>15</sup>) yes□ no□
...
#### II.   **ADDRESS TO WHICH THE FORM SHOULD BE RETURNED (<sup>16</sup>):**
...
#### III.   **DECLARATION OF THE ADDRESSEE (<sup>18</sup>):**
