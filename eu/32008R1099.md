...
| 15. Peat | A combustible soft, porous or compressed, sedimentary deposit of plant origin with high water content (up to 90 % in the raw state), easily cut, of light to dark brown colour. Peat used for non-energy purposes is not included. This definition is without prejudice to the definition of renewable energy sources in Directive 2009/28/EC of the European Parliament and of the Council (<sup>1</sup>) and to the 2006 IPCC Guidelines for National Greenhouse Gas Inventories. |
...
| (<sup>1</sup>)OJ L 140, 5.6.2009, p. 16. |  |
...
| 4.3. | Of which: used for heat generation Amounts used to generate heat at refineries. |
...
| 10. | Calculated Gross Inland Deliveries This is defined as: |
...
### 3. **Biogases from thermal processes**
