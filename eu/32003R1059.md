...
The grid-based typology shall be established at the 1 km<sup>2</sup> grid resolution level as follows:
...
| BE100 |  |  | Arr. (<sup>1</sup>) de Bruxelles-Capitale/Arr. Brussel-Hoofdstad |
| BE2 | Vlaams Gewest |  |  |
