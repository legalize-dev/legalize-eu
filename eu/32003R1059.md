...
| ITC4B |  |  | Mantova |
| ITD | NORD-EST |  |  |
| ITD1 |  | Provincia Autonoma Bolzano/Bozen (<sup>1</sup>) |  |
| ITD10 |  |  | Bolzano-Bozen |
...
| ITZZ |  | Extra-Regio |  |
| ITZZZ |  |  | Extra-Regio |
| (<sup>1</sup>)The Provincia Autonoma Bolzano/Bozen and the Provincia Autonoma Trento make up the region Trentino-Alto Adige/Südtirol. |  |  |  |
...
For Belgium ‘Gemeenten/Communes’,  for Bulgaria ‘Общини (Obshtini)’, for the Czech Republic ‘Obce’, for Denmark ‘Kommuner’, for Germany ‘Gemeinden’, for Estonia ‘Vald, Linn’, for Greece ‘Δήμοι/Κοινότητες (Dimoi/Koinotites)’, for Spain ‘Municipios’, for France ‘Communes’, for Ireland ‘Counties or Cities’, for Italy ‘Comuni’, for Cyprus ‘Δήμοι/Κοινότητες (Dimoi/Koinotites)’, for Latvia ‘Pilsētas, novadi, pagasti’, for Lithuania ‘Seniūnija’, for Luxembourg ‘Communes’, for Hungary ‘Települések’, for Malta ‘Localities’, for the Netherlands ‘Gemeenten’, for Austria ‘Gemeinden’, for Poland ‘Gminy, miasta’, for Portugal ‘Freguesias’,  for Romania ‘Municipii, Orașe, Comune’, for Slovenia ‘Občina’, for the Slovak Republic ‘Obce’, for Finland ‘Kunnat/Kommuner’, for Sweden ‘Kommuner’ and for the United Kingdom ‘Wards’.
