...
— whether the applicable critical limits referred to in point 2, point (c) have been met at each unit operation that is part of the manufacturing stage, and

— whether the quality of the resulting material meets pre-defined criteria, using the tests, protocols and evidence referred to in point 2, point (e) applicable to the manufacturing stage.
