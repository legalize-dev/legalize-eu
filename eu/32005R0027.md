...
| **Species**: Herring (<sup>1</sup>) *Clupea harengus* | **Zone**: IV north of 53°30′ NHER/4AB. |  |
| --- | --- | --- |
| Denmark | 95 211 |  |
| Germany | 57 215 |  |
| France | 20 548 |  |
...
| (<sup>1</sup>)Landed as the entire catch or sorted from the remainder of the catch, Member States must inform the Commission of their landings of herring distinguishing between ICES Divisions IVa and IVb (zones HER/04A. and HER/04B.). (<sup>2</sup>)May be taken in EC waters. Catches taken within this quota are to be deducted from Norway's share of the TAC. |  |  |
...
| (<sup>1</sup>)This quota may only be fished in ICES areas IV, VIa (north of 56°30′N) and VIIe, f, h. (<sup>2</sup>)Within a total quota of 6 500 tonnes for ICES Sub-areas IV, VIa (north of 56°30′N) and VIIe,f,h. |  |  |
