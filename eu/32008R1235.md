...
1. The Commission shall consider whether to recognise and include a control body or control authority in the list provided for in Article 3 upon receipt of a request thereto from the representative of the control body or control authority concerned on the basis of the model of application made available by the Commission in accordance with Article 17(2). Only complete requests that have been received before  31 October 2018 shall be taken into account for the drawing up of the first list.
...
| 5. | Control bodies : Code number Name Internet address AU-BIO-001 ACO Certification Ltd www.aco.net.au ————— AU-BIO-003 Bio-dynamic Research Institute (BDRI) www.demeter.org.au AU-BIO-004 NASAA Certified Organic www.nasaa.com.au AU-BIO-005 Organic Food Chain Pty Ltd (OFC) www.organicfoodchain.com.au AU-BIO-006 AUS-QUAL Pty Ltd www.ausqual.com.au |  |
| --- | --- | --- |
| Code number | Name | Internet address |
|  |  |  |
...
4. Competent authority : Servicio Fitosanitario del Estado, Ministerio de Agricultura y Ganadería, www.sfe.go.cr"?>www.sfe.go.cr
...
|  |  |  |
| JP-BIO-005 | Japan Organic & Natural Foods Association | http://jona-japan.org/english/"?>http://jona-japan.org/english/ |
|  |  |  |
...
|  |  |  |
| US-ORG-004 | Kiwa BCS Öko-Garantie GmbH | www.bcs-oeko.com"?>www.bcs-oeko.com |
|  |  |  |
| US-ORG-005 | BIOAGRIcert | http://www.bioagricert.org/english"?>http://www.bioagricert.org/english |
|  |  |  |
...
| US-ORG-043 | Organic Certifiers, Inc. | http://www.organiccertifiers.com"?>http://www.organiccertifiers.com |
...
| MK-BIO-151 | the former Yugoslav Republic of Macedonia | x | x | — | x | — | — |
...
| MK-BIO-139 | the former Yugoslav Republic of Macedonia | x | x | — | x | — | — |
...
| A | B | C | D | E | F |  |  |
|  |  |  |  |  |  |  |  |
| AE-BIO-135 | United Arab Emirates | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| AF-BIO-135 | Afghanistan | x | — |  | x | — | — |
|  |  |  |  |  |  |  |  |
| AR-BIO-135 | Argentina | — | — | x | x | — | — |
|  |  |  |  |  |  |  |  |
| AZ-BIO-135 | Azerbaijan | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| BO-BIO-135 | Bolivia | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| BR-BIO-135 | Brazil | x | x | x | x | — | — |
| BY-BIO-135 | Belarus | x | — | — | x | — | — |
| BZ-BIO-135 | Belize | x | x | x | x | — | — |
| CI-BIO-135 | Côte d'Ivoire | x | — | — | x | — | — |
| CO-BIO-135 | Colombia | x | x | x | x | — | — |
| CR-BIO-135 | Costa Rica | — | x | x | — | — | — |
| DO-BIO-135 | Dominican Republic | x | x | x | x | — | — |
|  |  |  |  |  |  |  |  |
| EC-BIO-135 | Ecuador | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| EG-BIO-135 | Egypt | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| ET-BIO-135 | Ethiopia | x | — |  | x | — | — |
|  |  |  |  |  |  |  |  |
| GT-BIO-135 | Guatemala | x | x | x | x | — | — |
| HN-BIO-135 | Honduras | x | x | x | x | — | — |
|  |  |  |  |  |  |  |  |
| IR-BIO-135 | Iran | x | — |  | x | — | — |
|  |  |  |  |  |  |  |  |
| KG-BIO-135 | Kyrgyzstan | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| KY-BIO-135 | Cayman Islands | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| KZ-BIO-135 | Kazakhstan | x | — |  | x | — | — |
|  |  |  |  |  |  |  |  |
| MA-BIO-135 | Morocco | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| MD-BIO-135 | Moldova | x | — |  | x | — | — |
|  |  |  |  |  |  |  |  |
| MX-BIO-135 | Mexico | x | — | — | — | — | — |
|  |  |  |  |  |  |  |  |
| PA-BIO-135 | Panama | x | x | x | x | — | — |
|  |  |  |  |  |  |  |  |
| PE-BIO-135 | Peru | x | — | x | — | — | — |
|  |  |  |  |  |  |  |  |
...
|  |  |  |  |  |  |  |  |
| RU-BIO-135 | Russia | x | — |  | x | — | — |
|  |  |  |  |  |  |  |  |
| SV-BIO-135 | El Salvador | x | x | x | x | — | — |
|  |  |  |  |  |  |  |  |
| TJ-BIO-135 | Tajikistan | x | — |  | x | — | — |
|  |  |  |  |  |  |  |  |
| TM-BIO-135 | Turkmenistan | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| TR-BIO-135 | Turkey | x | — |  | x | — | — |
| UA-BIO-135 | Ukraine | x | — |  | x | — | — |
|  |  |  |  |  |  |  |  |
| UY-BIO-135 | Uruguay | x | — | — | — | — | — |
|  |  |  |  |  |  |  |  |
| VN-BIO-135 | Uzbekistan | x | — | — | — | — | — |
|  |  |  |  |  |  |  |  |
...
| A | B | C | D | E | F |  |  |
|  |  |  |  |  |  |  |  |
| BA-BIO-162 | Bosnia and Herzegovina | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| ME-BIO-162 | Montenegro | x | — | — | x | — | — |
|  |  |  |  |  |  |  |  |
| MK-BIO-162 | the former Yugoslav Republic of Macedonia | x | — | — | x | x | — |
|  |  |  |  |  |  |  |  |
...
| KZ-BIO-108 | Kazakhstan | x | x | — | x | x | — |
| MD-BIO-108 | Moldova | x | x | — | x | — | — |
| RU-BIO-108 | Russia | x | x | — | x | x | — |
...
| A | B | C | D | E | F |  |  |
|  |  |  |  |  |  |  |  |
| AZ-BIO-166 | Azerbaijan | x | — | — | x | — | — |
| BA-BIO-166 | Bosnia and Herzegovina | x | — | — | x | — | — |
| GE-BIO-166 | Georgia | x | — | — | x | — | — |
| IR-BIO-166 | Iran | x | — | — | x | — | — |
| KG-BIO-166 | Kyrgyzstan | x | — | — | x | — | — |
| KZ-BIO-166 | Kazakhstan | x | — | — | x | — | — |
| ————— |  |  |  |  |  |  |  |
|  |  |  |  |  |  |  |  |
...
1.Address: Avenida Emilio Lemos, 2 mod. 603, 41020 Seville, Spain
