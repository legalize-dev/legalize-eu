...
*n*
 s [rpm] is specific speed of a circulator;

*n100 %* is rotational speed in rpm in this duty defined at *Q*
    100 % and *H*
    100 %.
...
(<sup>1</sup>) OJ L 330, 5.12.1998, p. 32.

(<sup>2</sup>) CXX % means a scaling factor that ensures that at the time of defining the scaling factor only XX % of circulators of a certain type have an EEI ≤ 0,20.
