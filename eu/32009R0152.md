...
Only primers and probes with sequences of oligonucleotides validated by the EURL-AP shall be used (<sup>33</sup>).

### 2.2.2.1.2.2.   **Master Mix**

Only Master Mix solutions which do not contain reagents susceptible to lead to false results due to presence of animal DNA shall be used (<sup>34</sup>).
...
(<sup>25</sup>) The list of these primers and probes for each animal species targeted by the assay is available on the EURL-AP website.

(<sup>26</sup>) Examples of Master Mixes that are functional are available on the EURL-AP website.
