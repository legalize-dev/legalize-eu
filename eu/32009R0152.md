...
Only primers and probes with sequences of oligonucleotides validated by the EURL-AP shall be used (<sup>44</sup>).

### 2.2.2.1.2.2.   **Master Mix**

Only Master Mix solutions which do not contain reagents susceptible to lead to false results due to presence of animal DNA shall be used (<sup>45</sup>).
...
(<sup>43</sup>) http://eurl.craw.eu/

(<sup>44</sup>) The list of these primers and probes for each animal species targeted by the assay is available on the EURL-AP website.

(<sup>45</sup>) Examples of Master Mixes that are functional are available on the EURL-AP website.
