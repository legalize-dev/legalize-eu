...
The mass emissions (mg/window) shall be determined as described in paragraph 8.4.2.3 of Annex 4 to UNECE Regulation No 49.
...
1.3.Description of the engine and vehicle type or types for which the replacement pollution control device is intended: …
 ...
 1.3.4.Is the replacement pollution control device compatible with existing vehicle/engine control systems (yes/no) (7 8 10)
...
1.3.1.Has the replacement pollution control device demonstrated compatibility with OBD requirements (yes/no) (7 8 10) : …
...
The following derogations are applied: Customer adaptations (<sup>10</sup>) — Small volume (7 8 10)  — Carry-over systems (7 8 10) .
...
(<sup>5</sup>) Directive 2001/85/EC of the European Parliament and of the Council of 20 November 2001 relating to special provisions for vehicles used for the carriage of passengers comprising more than eight seats in addition to the driver’s seat, and amending Directives 70/156/EEC and 97/27/EC (OJ L 42, 13.2.2002, p. 1).
