...
1.3.Description of the engine and vehicle type or types for which the replacement pollution control device is intended: …
 ...
 1.3.4.Is the replacement pollution control device compatible with existing vehicle/engine control systems (yes/no) (13)
...
of a type of component/separate technical unit (<sup>14</sup>)
...
0.3.Means of identification of type marked on the component/separate technical unit (<sup>15</sup>) (Identifying Part Number): …
...
1.3.1.Has the replacement pollution control device demonstrated compatibility with OBD requirements (yes/no) (15) : …
...
The following derogations are applied: Customer adaptations (<sup>16</sup>) — Small volume (16)  — Carry-over systems (16) .
...
(<sup>15</sup>) If the means of identification of type contains characters not relevant to describe the vehicle, component or separate technical unit types covered by this type-approval certificate such characters shall be represented in the document by the symbol: ‘?’ (e.g. ABC??123??).

(<sup>16</sup>) Delete where not applicable.
