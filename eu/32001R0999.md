...
3.5. The restrictions set out in points 3.1 to 3.4 shall continue to apply to the holding:
   ...
   (d) for a period of two years from the date when all the measures referred to in point 2.2.1, point 2.2.2(b), or point 2.2.2(c) have been completed, provided that no TSE case other than atypical scrapie is detected during this two-year period. If a case of atypical scrapie is confirmed during this two-year period the holding shall also be subject to the measures referred to in point 2.2.3.
