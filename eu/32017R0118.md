...
(c) rhumb lines sequentially joining the following coordinates in the German Exclusive Economic Zone:
   Point
    Latitude N (y)
    Longitude E (x)
    B02
...
(g) rhumb lines sequentially joining the following coordinates in the Dutch Exclusive Economic Zone
   Point
    Latitude N (y)
    Longitude E (x)
    B08
