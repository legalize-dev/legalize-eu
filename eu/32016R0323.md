...
The possible values are:
       ...
       — X05 = Rejected
       — X06 = Replaced
       — X07 = e-AD/e-SAD Manually Closed
       — X08 = Refused
       — X09 = None
       ...
       — X12 = (reserved)
       — X13 = Stopped
       — X14 = Accepted Export Declaration
       — X15 = e-AD Request Accepted for Export
       an3
       *d*
...
#### The possible values are:
       ...
       — IE836 = EXPORT DECLARATION INVALIDATION NOTIFICATION TO MSA OF DISPATCH/CONSIGNOR
       — IE839 = CUSTOMS REJECTION OF E-AD
       — IE881 = MANUAL CLOSURE RESPONSE
       — IE905 = STATUS RESPONSE
       — None = NONE
       *Note:*  *The IE905 should be included only for historical movements, which were manually closed with an IE905 message.*
       an..5
       *e*
...
The possible values are:
       ...
       n1
       *f*
       National Movement Information Requested flag
       R
...
The value of <Request Correlation Identifier> is unique per Member State
       an..44
       **2**
       **All validated e-ADs/e-SADs**
       R

The set of all draft electronic (simplified) administrative documents or electronic (simplified) administrative documents relating to the movement, the structure of which is set out in Table 1 of Annex I to *Delegated Regulation (EU) 2022/1636*
       99x
       **3**
       **All Reports of Receipt/Export**
       O

#### The set of all Report of receipt/Report of export messages relating to the movement, the structure of which is set out in Table 6 of Annex I to *Delegated Regulation (EU) 2022/1636*
       99x
       **4**
       **Last Notification of Diverted e-AD/e-SAD**
       O

The content of the last Notification of change of destination/Notification of splitting message relating to the movement, the structure of which is set out in Table 4 of Annex I to *Delegated Regulation (EU) 2022/1636*
       1x
       **5**
       **All Control Reports**
       O
...
#### The possible values are:
       — 1 = Explanation on delay for sending the report of receipt/export
       — 2 = Explanation on delay for giving destination
       n1
       *b*
...
#### an..350
       *g*
       ...
       — Does not apply otherwise
       *Provide the language code presented in Annex II to Delegated Regulation (EU) 2022/1636, Code list 1 to define the language used in this field*
       a2
       **7.2**
       **EXCISE MOVEMENT**
       R
...
#### The value of the Field must be greater than zero.
       n..2
       **8**
       **All Notifications of Accepted Export**
       O

The set of all messages ‘Notification of Accepted Export’ relating to the movement, the structure of which is set out in Table 7 of Annex I to *Commission Delegated Regulation (EU) 2022/1636*
       99x
       **9**
       **All Notifications of invalidation by Customs**
       O

The set of all messages ‘Export declaration invalidation notification to MSA of Dispatch/Consignor’ relating to the movement, the structure of which is set out in Table 9 of Annex I to *Commission Delegated Regulation (EU) 2022/1636*
       99x
       **10**
       **All Notifications of rejection by Customs**
       O

The set of all messages ‘Customs rejection of electronic administrative document’ relating to the movement, the structure of which is set out in Table 8 of Annex I to *Commission Delegated Regulation (EU) 2022/1636*
       99x
       **11**
...
The content of a possible ‘Interruption of movement’ message relating to the movement, the structure of which is set out in Table 13
       1x
       **12**
       **The Possible Cancellation of an e-AD**
       O

The content of a possible ‘Cancellation of the electronic administrative document’ message relating to the movement, the structure of which is set out in Table 2 of Annex I to *Delegated Regulation (EU) 2022/1636*
       1x
       **13**
       **All Changes of Destination**
       O

The set of all messages ‘Change of destination’ relating to the movement, the structure of which is set out in Table 3 of Annex I to *Delegated Regulation (EU) 2022/1636*
       99x
       **14**
       **All Alerts or Rejections of an e-AD/e-SAD**
       O

The set of all ‘Alert or Rejection of an e-AD/e-SAD’ messages relating to the movement, the structure of which is set out in Table 14
       99x
       **15**
...
The value of the Field must be greater than zero.
       ...
       **TRADER Consignor**
       ...
       — Does not apply otherwise
       *(see Submitter Type in box 15.1a)*
       *a*
...
For TRADER Consignor
       ...
       — ‘Certified consignor;
       OR
       An existing identifier <Temporary Authorisation Reference> in the set of <TEMPORARY AUTHORISATION>. The <Operator Type Code> of the referred <TRADER> must be ‘Temporary certified consignor’.
...
*Provide the language code presented in Annex II to Delegated Regulation (EU) 2022/1636, Code list 1 to define the language used in this field*
       ...
       *a*
       ...
       (4) The operator type of the consignee is "Temporary registered consignee". An existing <Temporary Authorisation Reference> in the set of <TEMPORARY AUTHORISATION>;
       (5) The operator type of the consignee is "Certified consignee". An existing identifier <Trader Excise Number> in the set of <TRADER AUTHORISATION>;
       (6) The operator type of the consignee is "Temporary certified consignee". An existing <Temporary Authorisation Reference> in the set of <TEMPORARY AUTHORISATION>;
       (7) The operator type of the consignee is ‘Certified consignor’. An existing identifier <Trader Excise Number> in the set of <TRADER AUTHORISATION>;
       (8) An existing <Temporary Authorisation Reference> in the set of <TEMPORARY AUTHORISATION> with Operator Type Code ‘Temporary Certified Consignor’.
...
— ‘O’ if <Destination Type Code> is ‘Destination – Export’
       — Does not apply otherwise
       Provide the EORI number of the person responsible for lodging the export declaration as set out in Article 21(1) of Council Directive (EU) 2020/262
       an..17
       *c*
       Trader Name
       R
...
*Provide the language code presented in Annex II to Delegated Regulation (EU) 2022/1636, Code list 1 to define the language used in this field*
       ...
       **ANALYSIS**
       C
       At least one of the <ANALYSIS> or <ANALYSIS Body> fields must be present
       *a*
       Date of Analysis
       R
...
The possible values are:
       ...
       — 3 = Reminder message at expiry of time to give destination information (Article 22 of Directive (EU) 2020/262)
       n1
       *b*
...
The possible values are:
       1 = (reserved)
       2 = Request for reference data
       3 = (reserved)
       4 = (reserved)
       5 = Request for re-synchronisation of the register of economic operators
       6 = Request for retrieval of a list of e-Ads/e-SADs
       7 = Request for SEED statistics
       8 = Request for retrieval of a list of e-Ads
       9 = Request for retrieval of a list of e-SADs
       n1
       *b*
...
The possible values are:
       ...
       3 = Categories of excise products of the movement
       4 = (reserved)
       5 = (reserved)
       6 = (reserved)
       7 = (reserved)
       ...
       11 = (reserved)
       12 = City of place of delivery
       13 = City of tax warehouse of dispatch
       14 = City of transporter
       15 = CN code of product
       16 = Date of invoice
       17 = Excise number of consignee
       18 = Excise number of consignor
...
The possible values are:
       1 = Active/Inactive and Deleted economic operators
       2 = Pending expirations
       3 = Economic operators by type and tax warehouses
       4 = Excise activity
...
The value of the field must be greater than zero.
       ...
       *REFERENCE SYNCHRONISATION*
       ...
       — Does not apply otherwise.
       *(See Request Type box 1a)*
       *a*
       Period from date
       R
       —
       This field must be prior or equal to field 5b.
       In case that an extraction is requested, the ‘Period from date’ and/or the ‘Period to date’ fields will be used to request occurrences valid in the specified period.
       On the contrary, in case a retrieval is requested, the ‘Period from date’ and/or the ‘Period to date’ fields will be used to request occurrences modified and published in the specified period.
       (*See box 5c*)
       date
       *b*
       Period to date
...
The possible values are:
       ...
       8 = Country codes
       9 = Packaging codes
       10 = Reasons for unsatisfactory receipt or control report
       11 = Reasons for interruption
       12 = (reserved)
       13 = Transport modes
       14 = Transport units
       15 = Wine-growing zones
       16 = Wine operation codes
       17 = Excise product categories
       18 = Excise products
       19 = CN codes
       20 = Correspondences CN code – Excise product
       21 = Cancellation reasons
       22 = Alert or rejection of e-AD/e-SAD reasons
       23 = Delay explanations
       24 = (reserved)
       25 = Event submitting persons
       26 = Refusal reasons
       27 = Reasons for delayed result
       28 = Request actions
       29 = Request reasons
       30 = (reserved)
       31 = (reserved)
       32 = (reserved)
       33 = (reserved)
       34 = Administrative cooperation action not possible reasons
       35 = (reserved)
       36 = Type of document
       37 = (reserved)
       38 = (reserved)
       39 = Manual Closure Request Reasons
       40 = Manual Closure Rejection Reasons
       41 = National Administration – Degree Plato
       n..2
      *Table 5*
...
an..182
       ...
       *TRADER Place of Dispatch*
       C
       IF <E-AD/E-SAD.Origin Type Code> is ‘Origin – Tax warehouse’ or ‘Origin – Duty Paid’
       THEN
       ...
       *a*
       ...
       C
       Doesn’t apply for Origin Type Code in box 9d ‘3’
       *(See for Origin Type Code box 9d in Table 1 of Delegated Regulation (EU) 2022/1636)*
       For TRADER Place of dispatch
       An existing identifier <Tax Warehouse Reference> (Excise Number in SEED).
       *(see Code list 1 in Annex II to Regulation (EU) No 612/2013)*
       an13
...
an..182
       ...
       *TRADER Place of Delivery*
       C
       The optionality of field <TRADER Place of Delivery> is described below, according to the <Destination Type Code>:
       ...
       *a*
       ...
       1 –  Destination – Tax warehouse
       Tax Warehouse Reference (Excise Number) (1)
       2 –  Destination – Registered consignee
       Any identification (*)
       3 –  Destination – Temporary registered consignee
       Any identification (*)
       ...
       Any identification (*)
       6 –  Destination – Export
       (The field <TRADER Place of Delivery> does not exist)
       ...
       11 –  Destination-Return to the place of dispatch of the consignor, for a Duty Paid B2B movement
       (The field <TRADER Place of Delivery> does not exist)
       (1) An existing identifier <Tax Warehouse Reference> in the set of <TAX WAREHOUSE>;
       (*)  For the place of delivery, "Any identification" means: a VAT number or any other identifier.
       *(see Code list 1 and Code list 2 in Annex II to Regulation (EU) No 612/2013, if applicable)*
       *b*
       Trader Name
       C
...
an..182
       ...
       *OFFICE Place of Delivery – Customs*
       C
       The optionality of the field <OFFICE Place of delivery – Customs> is described below, according to <Destination Type Code>:
       — ‘R’ for Destination Type Code 6
       — does not apply otherwise
       *a*
       Office Reference Number
       R
...
The possible values are:
       — 0 = Other
       — 2 = No e-AD(s) /e-SAD(s) retrieved matching selection criteria
       — 3 = Reference data not available
       — 4 = Excise Office List not available
       — 5 = SEED data not available
       — 7 = Unknown requested data
       — 8 = Increment number out of range
       — 26 = Duplicate detected
       — 112 = Incorrect (code) value
       — 115 = Not supported in this position
       n..3
      *Table 7*
...
*A National Administration identified by a Country Code in Code list 3 of Annex II to Delegated Regulation (EU) 2022/1636.*
       a2
       *d*
...
This attribute is used in the Administrative Cooperation Common Request to denote whether a special condition applies. The possible values are:
       0 = No special condition applies. The request follows the standard Administrative Cooperation process.
       1 = A special condition applies. The request requires additional attention.
       n1
       *3.1*
       *REQUEST REASON Code*
       R
...
The possible values are:
       — 1 = Administrative Cooperation answer message
       — 2 = reserved
       n1
       **2**
       **FOLLOW UP**
...
an..35
       ...
       *a*
       ...
       C
       For 3 a and b:
       — ‘R’ if < Refusal Reason Code> is provided
       — Does not apply otherwise
       *(see Refusal Reason Code in box 3c)*

dateTime
       *b*
       Delayed Result Reason Code
       C
...
*(see Code list 4 in Annex II)*
       ...
       *d*
       ...
       C
       — ‘R’ if < Refusal Reason Code> is ‘Other’
       — Does not apply otherwise
       *(see Refusal Reason Code in box 3c)*
...
The possible values are:
       — 1 = Administrative cooperation results reminder message
       — 2 = Reserved
       n1
       **2**
       **FOLLOW UP**
...
an..35
       i National Case Reference Identifier
       C
       — ‘O’ If <Follow Up Correlation ID> does not match with <Follow Up Correlation ID> in a request message
       — "R" If <Follow Up Correlation ID> matches with <Follow Up Correlation ID> in a request message AND
       — <National Case Reference Identifier> is present in the request message
...
an..70
       *3*
       *(ADMINISTRATIVE COOPERATION)ACTION RESULT*
       O
...
*(see Code list 2 in Annex II)*
       A ‘Control Report’ message exists in the system (including the case that it is encapsulated in a received ‘History of a movement’ message) having the same <Control Report Reference> with that of the submitted message. In addition if the <ARC> is provided in the submitted message then it coincides with the <ARC> of the referenced ‘Control Report’ message.
       *(see ARC in box 3a)*
       an16
       *4*
       *FEEDBACK REQUEST*
...
an..70
       ...
       *EXCISE MOVEMENT*
       C
       One of the <EXCISE MOVEMENT> or <OTHER ACCOMPANYING DOCUMENT> fields must be present
       *a*
       ARC
       R
...
an..55
       *b*
       CN Code
       C
       — ‘R’ if <OTHER ACCOMPANYING DOCUMENT.Image of Other Accompanying Document> is not present in the <OTHER ACCOMPANYING DOCUMENT> field
       — Does not apply otherwise
       *(see Data group 4 and box 4f)*
       The value of the Field must be greater than zero.
       n8
       *c*
...
an..35
       ...
       *f*
       ...
       — Does not apply otherwise
       *(see Data group 4 and box 4f)*
       *(See Annex II to Delegated Regulation (EU) 2022/1636, Code list 11)*
       n..2
       *g*
       Gross Mass
       O
...
*Provide a ‘Country Code’ listed in Code list 3 of Annex II to Delegated Regulation (EU) 2022/1636.*
       a2
       *e*
       Postcode
       R
...
*Provide the mode of transport using the codes in Code list 6 of Annex II to Delegated Regulation (EU) 2022/1636.*
       n..2
       *h*
       ACO_Complementary Information
       C
...
The possible values are:
       0 = Other reason
       1 = Control started at random
       2 = Event signalled
       3 = Request for assistance received
       4 = Request from another office
       5 = Alert received
       n1
       *f*
...
The possible values are:
       ...
       4 = Intention to make claim under Article 9 or Article 46 of Council Directive (EU) 2020/262
       5 = Allowable loss detected, in relation to Article 6 or Article 45 of Council Directive (EU) 2020/262
       n1
       *k*
...
This attribute indicates the outcome of the control. The possible values are:
       0 = Control positive, no irregularities detected
       1 = Control negative, irregularities detected.
       n1
       *m*
       Comments
       O
...
The possible values are:
       ...
       2 = Unloaded
       3 = Opened packs
       4 = Annotated paper copy of documents
       5 = Counting
       6 = Sampling
       ...
       11 = Compare documents presented with e-AD/e-SAD
       n..2
       *b*
...
*(see Code list 7 in Annex II to Delegated Regulation (EU) 2022/1636)*
       n..2
       *b*
...
99x
       *a*
       Body Record Unique Reference
       C
       — ‘R’ if <EXCISE MOVEMENT > field is present
       — Does not apply otherwise
       This value refers to the <Body Record Unique Reference> of the e-AD/e-SAD Body of the associated e-AD/e-SAD and must be unique within the message.
       The value of the Field must be greater than zero.
       n..3
       *b*
       Description of the Goods
       C
       — ‘O’ if the <OTHER ACCOMPANYING DOCUMENT> field is present
       — Does not apply otherwise
       —
       an..55
       *c*
       CN Code
       C
       — ‘R’ if the <OTHER ACCOMPANYING DOCUMENT> field is present
       — Does not apply otherwise
       The value of the Field must be greater than zero.
       n8
       *d*
...
dateTime
       ...
       *(see Message Type in box 1a)*
       ...
       — 2 alphabetic characters: Identifier of the National Administration of Submission of the event report
...
*(see Code list 3 in Annex II to Commission Delegated Regulation (EU) 2022/1636)*
       a2
       *3*
       *EXCISE MOVEMENT*
       C
...
an..55
       *b*
       ...
       C
       — ‘R’ if <OTHER ACCOMPANYING DOCUMENT. Image of Other Accompanying Document> is not present in the <OTHER ACCOMPANYING DOCUMENT> field
       — Does not apply otherwise *(see Data group 4 and box 4f)*
       The value of the Field must be greater than zero.
       n8
       *c*
       Commercial Description of the Goods
...
*(see Code list 10 in Annex II)*
       ...
       *g*
       ...
       — ‘O’ otherwise
       *(see Submitting Person Code in box 5f)*
...
*(see Code list 6 in Annex II)*
       ...
       *d*
       ...
       — Does not apply otherwise
       *(see Evidence Type Code in box 6c)*
...
*Provide the language code presented in Annex II to Delegated Regulation (EU) 2022/1636, Code list 1 to define the language used in this field.*
       ...
       *TRADER New Transport Arranger*
       ...
       — ‘R’ otherwise
       *(see Changed Transport Arrangement in box 5i)*
       *a*
       VAT Number
       O
...
*(see Code list 7 in Annex II to Delegated Regulation (EU) 2022/1636)*
       ...
       *b*
       ...
       — ‘R’ otherwise
       *(see Transport Unit Code in box 9a)*
...
an..350
       ...
       *EVENT REPORT Body*
       ...
       — ‘R’ otherwise
       *(see TRADER New Transport Arranger in Data group 7, TRADER New Transport in Data group 8, and TRANSPORT DETAILS in data group 9)*
...
*(see Code list 14 in Annex II)*
       ...
       *b*
       ...
       — ‘O’ otherwise
       *(see Event Type Code in box 10a)*
...
an..350
       ...
       *h*
       ...
       — Does not apply otherwise
       *(see Body Record Unique Reference in box 10d, Description of the Goods in box 10e, CN Code in box 10f and Additional Code in box 10g)*
       The possible values are:
       S = Shortage
       E = Excess
       a1
       i Observed Shortage or Excess
       C
       The value of the Field must be greater than zero.
       n..15,3
      *Table 13*
...
an..35
       *f*
       Complementary Information
       C
       — ‘R’ if <Reason for Interruption Code> is ‘Other’
       — ‘O’ otherwise
       *(see Reason for Interruption Code in box 1c)*
...
*(see Code list 2 in Annex II)*
       A ‘Control Report’ message exists in the system (including the case that it is encapsulated in a received ‘History of a movement’ message) having the same <Control Report Reference> and <ARC> with that of the submitted message.
       *(see ARC in box 1a)*
       an16
       **3**
       **EVENT REPORT Reference**
       O
...
*(see Code list 2 in Annex II)*
       An ‘Event Report’ message exists in the system (including the case that it is encapsulated in a received ‘History of a movement’ message) having the same <Event Report Number> and <ARC> with that of the submitted message
       *(see ARC in box 1a)*
       an16
      *Table 14*
...
Provide the ARC of the e-AD/e-SAD.
       *(see Code list 2 in Annex II to Delegated Regulation (EU) 2022/1636)*
       an21
       *b*
       Sequence Number
...
The value of the field must be greater than zero.
       ...
       *TRADER Consignee*
       D
       ‘R’, except for Destination Type Code 8
       *(See Destination Type Code in box 1a of Table 1 in Delegated Regulation (EU) 2022/1636)*
       *a*
       Trader Identification
       C
       — ‘R’ if <Destination Type Code> is:
...
The format of Boolean is digital: ‘0’ or ‘1’ (‘0’ = No or False; ‘1’ = Yes or True).
       n1
       *6*
       *ALERT OR REJECTION OF E-AD/E-SAD REASON Code*
       C
       — ‘R’ if <e-AD/e-SAD Rejected flag> is True
       — ‘O’ if otherwise
       —
       9x
       *a*
...
*(see Code list 5 in Annex II)*
       ...
       *b*
       Complementary Information
       C
       — ‘R’ if <Alert or Rejection of Movement Reason Code> is ‘Other’
       — ‘O’ otherwise
       *(see Alert or Rejection of Movement Reason Code in box 6a)*
...
Provide the ARC of the e-AD or e-SAD.
       *(see Code list 2 in Annex II to Delegated Regulation (EU) 2022/1636)*
       an21
       *b*
       Sequence Number
...
This value refers to the <Body Record Unique Reference> of the Body of the associated e-AD / e-SAD and must be unique within the message.
...
For excise goods under duty suspension:
       The date at which the movement ends in accordance with Article 19(2) of Council Directive (EU) 2020/262.
       For duty paid excise goods:
       The date at which the movement ends in accordance with Article 33(4) of Council Directive (EU) 2020/262.
       date
       *d*
...
*(see Code list 10 in Annex II to Delegated Regulation (EU) 2022/1636)*
       ...
       *e*
       Refused Quantity
       D
       — ‘O’ if <Global Conclusion of Receipt> is ‘Receipt partially refused’
       — Does not apply otherwise
       The value of this field must be greater than zero.
       n..15,3
       *f*
