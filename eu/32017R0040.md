...
In the case of aid applications relating to accompanying educational measures only, points (a) and (c) of paragraph 1 shall not apply. Competent authorities may specify any additional written commitments to be undertaken by applicants, in particular as regards:
