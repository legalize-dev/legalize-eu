...
(1) The German and Polish language versions of the Annex to Commission Implementing Regulation (EU) 2021/632 (2) contain errors that change the scope of goods subject to official controls at border control posts.

(2) The German and Polish language versions of the Annex to Implementing Regulation (EU) 2021/632 should therefore be corrected accordingly. The other language versions are not affected.
