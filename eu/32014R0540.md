...
12.9.1. Approval number of a type of vehicle with regard to its sound emission pursuant to UNECE Regulation No 138 (<sup>1</sup>)
   or

12.9.2. Complete reference to the test results of AVAS sound emission levels, measured in accordance with Regulation (EU) No 540/2014 (<sup>1</sup>).
...
3 Compensating reservoir from 35 to 40 l.

4 Pressure switch 5 kPa to 250 kPa — to open item 7.

5 Time delay switch — to close item 7.

6 Counter of impulses.

7 Quick response valve — such as the valve of an exhaust brake system of 60 mm in diameter, operated by a pneumatic cylinder with an output of 120 N at 400 kPa. The response time, both when opening and closing, shall not exceed 0,5 s.
