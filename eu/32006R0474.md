...
| (<sup>1</sup>)Afrijet is only allowed to use the specific aircraft mentioned for its current operations within the European EU. (<sup>2</sup>)Air Astana is only allowed to use the specific aircraft mentioned for its current operations within the European EU. (<sup>3</sup>)Gabon Airlines is only allowed to use the specific aircraft mentioned for its current operations within the European EU. (<sup>4</sup>)Iran Air is allowed to operate to the European Union using the specific aircraft under the conditions set out in recital (69) of this Regulation. |  |  |  |  |  |  |
