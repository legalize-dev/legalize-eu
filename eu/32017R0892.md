...
2. Where a standard import value is established for the products and for the periods of application set out in Part A of Annex VII to Delegated Regulation (EU) 2017/891, in accordance with Articles 74 and 75 of that Regulation and this Article, the unit price as referred to in Article 142 of Commission Implementing Regulation (EU) 2015/2447 (<sup>4</sup>) shall not apply. It shall be replaced by the standard import value referred to in paragraph 1.
...
7. The standard import values expressed in euro shall be published by the Commission via TARIC (<sup>5</sup>).
...
| Volume *(tonnes)* |  |  |  |
| Total area under fruit and vegetables production *(ha)* (<sup>*1</sup>) |  |  |  |
| (<sup>1</sup>)This table refers to Member States where the head offices of TPOs are located. (<sup>*1</sup>) *excluding mushrooms* |  |  |  |
...
| Volume *(tonnes)* |  |  |  |
| Total area under fruit and vegetables production *(ha)* (<sup>*1</sup>) |  |  |  |
| (<sup>1</sup>)This table refers to Member States where the head offices of APOs are located. (<sup>*1</sup>) *excluding mushrooms* |  |  |  |
...
| Volume *(tonnes)* |  |  |  |
| Total area under fruit and vegetables production *(ha)* (<sup>*1</sup>) |  |  |  |
| (<sup>1</sup>)This table refers to Member States where the head offices of TAPOs are located. (<sup>*1</sup>) *excluding mushrooms* |  |  |  |
